...
**Prethink** is a set of OpenRewrite recipes that generate trusted context for LLM coding agents like Claude Code, Cursor, and GitHub Copilot.
...
This project is licensed under the [Moderne Source Available License](https://docs.moderne.io/licensing/moderne-source-available-license).
